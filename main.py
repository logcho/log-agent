...
def print_welcome_banner():
    ...
    banner_text.append("📂 Filesystem (os):\n", style="bold cyan")
    banner_text.append("  • list_directory, get_current_directory, change_current_directory\n", style="white")
    banner_text.append("  • create_directory, remove_path, move_or_rename, get_metadata\n", style="white")
    banner_text.append("  • read_file, write_file, find_files\n", style="white")
    banner_text.append("💻 Terminal (subprocess):\n", style="bold cyan")
    banner_text.append("  • run_command, open_application\n", style="white")
    banner_text.append("🖥️ GUI Automation (pyautogui & OCR):\n", style="bold cyan")
    ...
    banner_text.append("  • gui_get_screen_text, gui_click_text_on_screen, gui_fill_labeled_input\n", style="white")
